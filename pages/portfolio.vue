<template>
  <div class="my-4 mx-16 container max-w-3xl mx-auto px-6 font-body">
    <div class="flex">
      <a href="#reflection" class="inline-block p-4 font-bold border">Opening Week Reflection</a>
      <a href="#diversity" class="inline-block p-4 font-bold border">Diversity Plan</a>
      <a href="#lesson-plans" class="inline-block p-4 font-bold border">Lesson Plans</a>
    </div>

    <div class="content" id="reflection">
      <h2 id="ose-reflection">OSE REFLECTION</h2>
    ...
    <div class="content" id="diversity">
      ...
      <p> Works Cited
        Brown, D., &amp; Knowles, T. (2007). Create a Safe Haven for Learning. In B. a. Knowles, What Every Middle School Teacher Should Know. Portsmouth, NH: Heinemann.
        Herzig, A. (2005). Goals for Achieving Diversity in Mathematics Classrooms. Mathematics Teacher, 253.
        Shepard, L. (2005, April). Teaching with Integrity in the Face of High-stakes Tasting. Montreal, Quebec: Paper presented at the annual meeting of the American Educational Research Association.
        Sleeter, C. (2005, April). Case Studies of Teacher Testing for Democracy in an Age of Accountability. Montreal, Quebac: Paper presented at the annual meeting of the American Educational Research Association.</p>
    </div>
